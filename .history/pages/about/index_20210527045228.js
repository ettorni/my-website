...
function AboutPage() {
  return (
    <div className={classes.textColor}>
      <Viewport mobile={<AboutIntroMobile />} desktop={<AboutIntro />} />
      <Viewport mobile={null} desktop ={
      <{<div className={classes.divider}>
        <hr />
      </div>
      } />
      <div>
        <Viewport mobile={<MobileHistory />} desktop={<History />} />
      </div>
      <div className={classes.divider}>
        <hr />
      </div>
      <Viewport mobile={<MobileInterests />} desktop={<Interests />} />
    </div>
  );
}
