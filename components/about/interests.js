  ...
  return (
    <div className={classes.container}>
      ...
      <div className={"row " + classes.margin}>
        <div className={classes.ltext + " col-lg-6 col-md-6"}>
          <h3>Soccer</h3>
          <p>
        ...
        <div className={classes.rimage + " col-lg-6 col-md-6"}>
          <Image
      ...
      <div className={"row " + classes.margin}>
        <div className={classes.limage +" col-lg-6 col-md-6"}>
          <Image
        ...
        <div className={classes.rtext + " col-lg-6 col-md-6"}>
          <h3>Music</h3>
          <p>
      ...
      <div className={"row " + classes.margin}>
        <div className={classes.ltext + " col-lg-6 col-md-6"}>
          ...
          <p>
            ...
            settings that I used to be a lot in. My favourite desserts to make
